...
namespace OhKeyCapsTester.MessageBusService
{
    ...
    public class MessageBus : IMessageBus
    {
        ...
        private static Func<bool> _uiThreadMarshallerCheckAccess;
        ...
        public MessageBus(Action<Action> uiThreadMarshaller, Func<bool> uiThreadMarshallerCheckAccess)
        {
            _uiThreadMarshaller = uiThreadMarshaller;
            _uiThreadMarshallerCheckAccess = uiThreadMarshallerCheckAccess;
        }
        ...
        {
            private static readonly Dictionary<Type, List<Handler>>
                HandlerCache = new Dictionary<Type, List<Handler>>();
            ...
            private class Handler
            {
                ...
                public void Invoke(object target, object message)
                {
                    ...
                    {
                        //
                        // Updated mashalling to check access and only dispatch if access is not allowed.
                        //
                        if (null != _uiThreadMarshallerCheckAccess && !_uiThreadMarshallerCheckAccess())
                        {
